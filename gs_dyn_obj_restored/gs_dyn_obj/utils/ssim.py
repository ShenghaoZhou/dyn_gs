...
def image_loss(render_image, image_tensor, lambda_dssim=0.2):
    l1_loss = F.l1_loss(render_image, image_tensor)
    ssim_loss = ssim(render_image, image_tensor)
    loss = (1 - lambda_dssim) * l1_loss + lambda_dssim * (1 - ssim_loss)
    return loss
